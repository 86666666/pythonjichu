...
#要求1，将给tomcat写好的systemctl单元配置1.txt文件放到/home/wangkaixuan 目录下
#要求2，将apache-tomcat-9.0.62.tar.gz 安装包复制到 /home/wangkaixuan 目录下
#要求3，将本py脚本放到/home/wangkaixuan 目录下
...
a11='sudo chown -R tomcat:  /home/wangkaixuan/tomcat'              #修改目录归属到用户和用户组
...
a16='systemctl start tomcat.service'                               #关闭tomcat服务
